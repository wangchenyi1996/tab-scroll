 ...
 * @LastEditors: 王强
 * @LastEditTime: 2020-06-23 15:39:06
--> 
<template>
  <div style="width:100%">
    ...
    <ul class="my-ul">
      ...
      <li @click="$router.push('/vars')"> 动态页面换肤功能</li>
    </ul>
...
export default {
  ...
  methods: {
    // 跳转到html5
    naviHtml(){
      let routeUrl =this.$router.resolve({path: '/html5'})
  ...
  directives: {
    test: {
      inserted(el){
        console.log('我是insert方法',el)
      },
      bind(el, binding) {
        console.log('我是bind方法',el)
        // console.log(binding)
      },
      update(el) {
        console.log('我是update方法',el)
      },
      unbind(el){
         console.log('我是unbind方法',el)
      }
    },
    focus:{
...
.article {
  ...
  article {
    ...
    background-size: 100% calc(100% - 300px + 5px);
    > * {
      position: relative;
      z-index: 9;
    }
